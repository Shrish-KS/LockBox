    ...
    return MaterialApp(
      home: Scaffold(
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            widget.repo==""?_displayDialog(context):"";
          },
        ),
        appBar: AppBar(
          backgroundColor: Colors.purple,
        ...
        body: Column(
          children: [
            Container(
              child: file.length==0?Center(child: widget.repo==""?Text("You have not created any directories"):Text("You have no Files in Your directory")):Column(
                children: <Widget>[
                  Expanded(
